...
<script src="<?= base_url("assets/dashboard/js/core/jquery.min.js");?>" type="text/javascript"></script>
  ...
  <script src="<?= base_url("assets/dashboard/js/plugins/additional-methods.min.js");?>"></script>
  <script src="<?= base_url("assets/dashboard/js/plugins/jquery.maskMoney.min.js");?>"></script>
  ...
  <script src="<?= base_url("assets/dashboard/js/plugins/jscolor.js"); ?>"></script>
